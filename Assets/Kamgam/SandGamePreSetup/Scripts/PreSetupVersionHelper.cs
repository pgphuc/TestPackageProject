...
{
    public static class PreSetupVersionHelper
    {
        public static string VersionFileName = "." + typeof(PreSetupVersionHelper).FullName.Replace("Helper", "") + ".txt";
        ...
        public static Version Parse(string version)
        {
            ...
            if (Version.TryParse(version, out var versionObj))
                ...
                return PreSetupVersionHelper.DefaultVersion;
        }
        ...
        {
            return PreSetupWindow.AssetRootPath.Trim();
        }
