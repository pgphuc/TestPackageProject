...
namespace Kamgam.SandGame
{
    public class Installer : IActiveBuildTargetChanged
    {
        ...
        public const string Define = "KAMGAM_SAND_GAME";
		public const string AssetLink = "https://assetstore.unity.com/packages/slug/267575";
		
		public static string AssetRootPath = "Assets/Kamgam/SandGame/";

        public static Version GetVersion() => new Version(Kamgam.SandGame.PreSetup.PreSetupWindow.Version);
        ...
        [MenuItem("Tools/" + AssetName + "/Setup", priority = 201)]
        public static void Install()
        {
            MaterialShaderFixer.FixMaterialsDelayed(null);
            AddressabelesSetup.AddGroup();
            SceneSetup.SetupBuildScenesDelayed();
            showWelcomeMessage();
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [MenuItem("Tools/" + AssetName + "/Manual", priority = 202)]
        public static void OpenManual()
        {
            Application.OpenURL(PreSetup.PreSetupWindow.ManualUrl);
        }

        
        [MenuItem("Tools/" + AssetName + "/Open Demo Scene", priority = 103)]
        ...
        [MenuItem("Tools/" + AssetName + "/Version " + Kamgam.SandGame.PreSetup.PreSetupWindow.Version, priority = 512)]
        public static void LogVersion()
        {
            Debug.Log(AssetName + " v" + Kamgam.SandGame.PreSetup.PreSetupWindow.Version);
        }
    }
}
#endif